...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <motion.div style={{ y, opacity }} className="site-shell relative z-10 py-24 text-center">
        <motion.h1
          initial={{ opacity: 0, y: 26, filter: "blur(10px)" }}
          animate={{ opacity: 1, y: 0, filter: "blur(0px)" }}
          transition={{ duration: 1, ease: [0.22, 1, 0.36, 1] }}
          className="text-balance text-[clamp(4.4rem,14vw,12rem)] font-semibold leading-[0.82] tracking-[-0.075em]"
        >
        ...
        >
          <p className="mt-9 text-[clamp(1.35rem,3vw,2.2rem)] font-medium tracking-[-0.035em] text-white/90">
          ...
          <div className="mt-9 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center">
            <ArrowLink href="#videos">YouTube ansehen</ArrowLink>
